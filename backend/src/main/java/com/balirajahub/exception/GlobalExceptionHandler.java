...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CropReminderNotFoundException.class)
    public ResponseEntity<ApiResponse<Object>> handleCropReminderNotFoundException(
            CropReminderNotFoundException ex) {
